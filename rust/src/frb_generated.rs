...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 317694745;
...
fn wire__crate__api__rust_manager__fun_with_only_callback_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok = Result::<_, ()>::Ok({
                            crate::api::rust_manager::fun_with_only_callback(api_dart_callback)
                                .await;
                        })?;
                        Ok(output_ok)
                    })()
...
fn wire__crate__api__rust_manager__fun_with_return_callback_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok = Result::<_, ()>::Ok({
                            crate::api::rust_manager::fun_with_return_callback(api_dart_callback)
                                .await;
                        })?;
                        Ok(output_ok)
                    })()
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        7 => wire__crate__api__rust_manager__fun_with_only_callback_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        8 => wire__crate__api__rust_manager__fun_with_return_callback_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        11 => wire__crate__api__rust_manager__init_app_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__simple__rust_function_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        4 => wire__crate__api__rust__connect_sync_impl(ptr, rust_vec_len, data_len),
        6 => wire__crate__api__rust__disconnect_sync_impl(ptr, rust_vec_len, data_len),
        9 => wire__crate__api__simple__greet_impl(ptr, rust_vec_len, data_len),
        14 => wire__crate__api__rust__send_request_sync_impl(ptr, rust_vec_len, data_len),
        15 => wire__crate__api__rust__start_responder_sync_impl(ptr, rust_vec_len, data_len),
        16 => wire__crate__api__rust__stop_responder_sync_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}

...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1230182272;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        4 => wire__crate__api__rust__init_app_impl(port, ptr, rust_vec_len, data_len),
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        2 => wire__crate__api__rust__disconnect_sync_impl(ptr, rust_vec_len, data_len),
        3 => wire__crate__api__simple__greet_impl(ptr, rust_vec_len, data_len),
        6 => wire__crate__api__rust__send_request_sync_impl(ptr, rust_vec_len, data_len),
        7 => wire__crate__api__rust__start_responder_sync_impl(ptr, rust_vec_len, data_len),
        8 => wire__crate__api__rust__stop_responder_sync_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
